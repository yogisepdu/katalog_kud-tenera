...
<div class="kontakwa">
  <a href="https://wa.me/<?php echo str_replace('+','',$site->hp) ?>?text=Saya%20tertarik%20untuk%20Dengan%20Layanan%20KUD%20Tenera%Mukti%Bakti.%20.%20Apakah%20boleh%20saya%bertanya?" class="topbar-social-item"><i class="fa fa-whatsapp"></i>
        </a>
</div>
<!-- END WA -->
<?php 
...
<div class="row">
    <div class="footer-bottom">
        <div class="copyright-txt">
            <p>&copy; <?php echo date('Y') ?>. Designer By <a href="http://kudteneramukti.com" title="Java Web Media">Mardila Risky Safitri</a></p>
        </div>
        <!-- .copyright-txt -->
