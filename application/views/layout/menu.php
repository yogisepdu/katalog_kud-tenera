...
<!-- galeri -->
          <!--   <li class="dropdown">
                ...
                <ul class="dropdown-menu sub-menu">
                    ...
                    <li class="sub-active"><a href="<?php echo base_url('galeri'); ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Galeri ALbum Foto</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu sub-menu">
                    ...
                    <?php } ?>
                    <li class="sub-active"><a href="<?php echo base_url('berita') ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Indeks All Berita</a></li>                   
                </ul>
            </li>

            <!-- LAYANAN -->
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">KEANGGOTAAN<span class="caret"></span></a>
                <ul class="dropdown-menu sub-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu sub-menu">
                    ...
                    <li class="sub-active"><a href="<?php echo base_url('galeri'); ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i>ALbum Foto</a></li>
                   <!--  <li class="sub-active"><a href="<?php echo base_url('video'); ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Galeri Video</a></li>     -->               
                </ul>
            </li>
