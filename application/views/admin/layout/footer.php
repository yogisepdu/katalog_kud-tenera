...
.then((willDelete) => {
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024<a href="http://adminlte.io">AdminLTE.io</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- ./wrapper -->
<!-- Bootstrap 4 -->
<script src="<?php echo base_url() ?>assets/admin/plugins/bootstrap/js/bootstrap.bundle.aldimin.js"></script>
<!-- Select2 -->
