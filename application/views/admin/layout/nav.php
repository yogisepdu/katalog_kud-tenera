        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>Berita, Profil &amp; Informasi <i class="right fa fa-angle-left"></i></p>
            </a>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
             <li class="nav-item"><a href="<?php echo base_url('admin/download') ?>" class="nav-link"><!-- <i class="fa fa-table nav-icon"> --></i><p>(Data Download)</p></a></li>
        ...
        <?php } ?> -->
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>Konfigurasi Website<i class="right fa fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
